...
# be used to acquire:
# - off-the-shelf reconfiguration of the SQLAlchemy engine
# - construction of migration environment context objects
# - logging to file and console during the generate and offline modes
# though to use the "offline" variant of this lets generate the migration scripts for each target databases.
